...
* **product:** protect artifacts and complete build and diagnostic workflows ([#14](https://github.com/P4suta/ginary/issues/14)) ([d82107f](https://github.com/P4suta/ginary/commit/d82107fe01206adf7aac87de3e50183753c91400))
...
* **ci:** resolve the fuzz workspace's own lockfile, and repair it ([#30](https://github.com/P4suta/ginary/issues/30)) ([a614aff](https://github.com/P4suta/ginary/commit/a614aff7061c08acb790ba628dd040b39e0d3987))
* **deps:** rustls 0.23.43 -&gt; 0.23.45 for RUSTSEC-2026-0285 ([#35](https://github.com/P4suta/ginary/issues/35)) ([de5b05b](https://github.com/P4suta/ginary/commit/de5b05b9db8d8f4133cdceb95933be96c2163475))
* **docs:** take the proved Windows launch out of the deferred list ([2e19b9d](https://github.com/P4suta/ginary/commit/2e19b9d669a804fa08a5f03146e8b2f718251e3f))
* **macos:** qualify the suite on a macOS host, and fix what that found ([#17](https://github.com/P4suta/ginary/issues/17)) ([dd3ca9b](https://github.com/P4suta/ginary/commit/dd3ca9b0c53e5a4c2b9c8e1d0ae69b1fa2aa2026))
* **mutants:** divisions that fit the source, and a plan check on every change ([#32](https://github.com/P4suta/ginary/issues/32)) ([72ccad8](https://github.com/P4suta/ginary/commit/72ccad80aaa2d0dad6521fd63a89e63d1a68b809))
* **release,download:** read the release state from the record, authenticate the API ([#9](https://github.com/P4suta/ginary/issues/9)) ([70d3f4f](https://github.com/P4suta/ginary/commit/70d3f4f4020df9798f58a68e4fcbd7c14fe40470))
